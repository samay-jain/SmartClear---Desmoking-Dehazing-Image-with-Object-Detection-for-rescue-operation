...
class HazeRemoval(object):
    def __init__(self, omega=0.96, t0=0.1, radius=7, r=20, eps=0.001):
        self.omega = omega
        self.t0 = t0
        self.radius = radius
        self.r = r
    ...
    def get_processed_image(self):
        return self.dst#cv2.cvtColor(self.dst, cv2.COLOR_RGB2BGR)

    def process_image(self, imagepil):
        self.open_image(imagepil)
